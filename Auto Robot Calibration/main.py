...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.MenuLeft.place(relx=0.01, rely=0.01, relwidth=0.49, relheight=0.98)
        ...
        self.CalibrateButton = CalibrateButton(self.MenuRight)
        self.CalibrateButton.place(relx=0.35, rely=0.1)
